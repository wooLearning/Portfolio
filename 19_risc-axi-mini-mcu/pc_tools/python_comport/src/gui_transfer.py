...
class TransferGui(tk.Tk):
    def __init__(self) -> None:
        ...
        self.image_path = tk.StringVar(value=str(self.root_dir / "image" / "rainbow64x64_rgb888.png"))
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Button(files, text="New Name", command=self.new_output_name).grid(row=1, column=2, sticky="ew", pady=(8, 0))
