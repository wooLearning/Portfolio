...
// Generated from src/timing_programs/Bubble Sort.mem.
module InstrRom_timing_bubble #(
  ...
  assign wMem[0] = 32'h10000413;
  assign wMem[1] = 32'h00400493;
  assign wMem[2] = 32'h11000913;
