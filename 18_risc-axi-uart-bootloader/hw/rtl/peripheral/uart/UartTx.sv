...
[MODULE_INFO_START]
Name: UartTx
Role: 8N1 UART transmitter without bus protocol coupling
Summary:
  - Sends one 8-bit character per iValid pulse
  - Uses a 16x baud tick
  - Keeps TX idle high between frames
StateDescription:
  - S_IDLE: wait for iValid
  - S_START: drive start bit
  - S_DATA: shift 8 data bits LSB first
  - S_STOP: drive stop bit
[MODULE_INFO_END]
*/
module UartTx (
  input  logic       iClk,
