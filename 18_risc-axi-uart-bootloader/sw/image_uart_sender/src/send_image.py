...
from protocol import build_packet, chunks, load_image_frame, now_stamp, write_json
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--chunk-size", type=int, default=1024, help="Write chunk size in bytes.")
    parser.add_argument("--chunk-delay", type=float, default=0.0, help="Delay between chunks in seconds.")
