...
Generated logs and default output images stay under the project-level output folders:
...
```text
runs/sender_outputs/received_*.png
runs/sender_outputs/received_*_diff.png
runs/sender_outputs/received_*_rx.txt
logs/sender/transfer_*.json
```
