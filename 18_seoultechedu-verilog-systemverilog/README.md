...
> [wooLearning/SeoulTechEdu](https://github.com/wooLearning/SeoulTechEdu)를 포트폴리오 안에서 바로 볼 수 있도록 로컬 클론한 폴더입니다. 부모 포트폴리오 저장소에서 일반 프로젝트 파일로 관리할 수 있도록 clone의 Git 메타데이터는 비활성화했습니다.
...
- [SPI_I2C_UVM](./SPI_I2C_UVM/README.md)
...
| [SPI_I2C_UVM](./SPI_I2C_UVM/README.md) | SPI/I2C singleboard loopback UVM verification | [README.md](./SPI_I2C_UVM/README.md) | `260420_SPI_I2C_UVM_Verification_우상욱_code/src`, `uvm_tb` | `발표자료/`, 영상, ZIP |
