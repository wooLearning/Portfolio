...
- `sb_minimal_top` 하나를 대상으로 SPI/I2C loopback을 UVM으로 검증한 프로젝트입니다.
- 외부 장치 모델 없이도 하나의 DUT 안에서 protocol transaction과 register state 변화를 end-to-end로 보여주는 데 강점이 있습니다.
- 발표자료, 영상, 코드 압축본이 함께 있어 mid-project 발표 자료와 실제 UVM 코드를 같이 보기 좋습니다.
...
| SPI/I2C loopback UVM 검증 | `SPI_I2C_UVM` |
