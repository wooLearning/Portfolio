...
module i2c_slave (
  ...
  assign wStartDet =  rSdaPrev && !iSda && iScl;
  assign wStopDet  = !rSdaPrev &&  iSda && iScl;
  assign wSclRise  = !rSclPrev &&  iScl;
  assign wSclFall  =  rSclPrev && !iScl;
      ...
      case (rCurState)
        ...
        ADDR: begin
          if (wStartDet) begin
            ...
            wAddrFrame = {rAddrShift[6:0], iSda};
